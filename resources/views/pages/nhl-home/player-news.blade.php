            ...
            <div class="nhl-pn-container-header container-header">
                ...
                <div class="nhl-pn-container-slider container-slider">
                    <div class="nhl-pn-slider-wrapper slider-wrapper">
                        ...
                        <div  class="nhl-pn-image-list home-pn-image-list image-list">
                            @php
                                $pn_count = 0;
                                $pn_bg_color = '';
                                $pn_type_icon = ''
                            ...
                            @foreach($player_news->data as $key=>$val)
                                @php
                                    $pn_count++
                                @endphp
                                <div class=" ddd aaa {{ (request()->segment(1) == 'nba') ? 'nba-image-item' : '' }} {{ (request()->segment(1) == 'nhl') ? 'nhl-pn-image-item' : '' }} {{ (request()->segment(1) == 'mlb') ? 'mlb-image-item' : '' }} {{ (request()->segment(1) == 'nfl') ? 'nfl-image-item' : '' }} {{ (request()->segment(1) == 'epl') ? 'epl-image-item' : '' }} home-pn-image-item image-item" >
