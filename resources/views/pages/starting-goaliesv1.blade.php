...
@section('content')
    ...
    <!-- Desktop Design -->
    <div class="flex justify-between lg:flex-row md:flex-col sm:flex-col smm-hidden">
            <div class="flex flex-col ">
                <div class="bg-lime-400 w-36 h-full">
                </div>
                <div class="bg-lime-400 w-36 h-full mb-10 mt-10">
                </div>
                <div class="bg-lime-400 w-36 h-full">
                </div>
            </div>
        <div class=" flex flex-col">  
                            <div class=" bg-lime-400 w-7/12 m-auto h-28 flex justify-center items-center  mt-5 mb-5">
