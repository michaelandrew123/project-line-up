...
@section('content')
    ...
    <div class="w-full flex flex-col items-center  ">
        <div class="relative   flex flex-row justify-center gap-3 items-center  xl:w-11/12 lg:w-11/12  md:w-11/12 sm:w-11/12  w-11/12 md:max-w-screen-2xl h-auto">
    ...
    {{--                                            <h1 class="font-bold text-lg mt-2 player" >{{ (isset($season->starting_goalies->home->player->full_name) ? $season->starting_goalies->home->player->full_name : " ")  }}</h1>--}}
                                                <div class="player-card flex flex-col gap-4 bg-white w-full justify-center text-center items-center w-34 rounded-lg">
                                                    <div class="p-4 ">
                                                ...
                                                <div class="flex flex-row items-center justify-center gap-2 text-sm font-bold bg-white  border border-black rounded-lg w-full p-2 text-center starting-goalies-view-card cursor-pointer view-news" rel="sg-view-card-home-{{$season->starting_goalies->home->id}}" >
                                                    ...
                                                    <div class="flex flex-col justify-evenly h-full">
                                                            <div class="sg-container flex flex-col h-full justify-between py-8 gap-2" >
                                                                <div class="flex flex-row justify-evenly gap-4">
                                                                    <div class="flex flex-row items-center gap-1 sg-dark-mode">
                                                                ...
                                                                <div class="flex flex-row justify-between px-6 py-4 sg-dark-mode">
                                                                    <div class="flex flex-row justify-evenly gap-4 text-center">
                                                                        <div class="p-2 gap-2  ">
                                                                            <div class="text-black text-sm  cards-dm-black">GOALS</div>
                                                                            <div class="bg-[#F4F5F7]   p-6 rounded-lg  font-bold sg-dark-mode cards-dm-black">{{ (isset($season->home_team->odds->team_goal) ? $season->home_team->odds->team_goal : "")  }}</div>
                                                                        </div>
                                                                        <div class="p-2 gap-2  ">
                                                                            <div class="text-black text-sm  cards-dm-black">WIN %</div>
                                                                            <div class="bg-[#F4F5F7]  p-6 rounded-lg  font-bold sg-dark-mode cards-dm-black">{{ (isset($season->home_team->odds->win_percentage) ? $season->home_team->odds->win_percentage : "")  }}</div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="flex flex-row justify-evenly text-center">
                                                                        <div class="p-2 gap-2 ">
                                                                            ...
                                                                            <div class="bg-[#F4F5F7]  p-6 rounded-lg  font-bold sg-dark-mode cards-dm-black">{{ (isset($season->home_team->odds->over_under) ? $season->home_team->odds->over_under : "")  }}</div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="flex flex-row justify-evenly gap-4 text-center" >
                                                                        <div class="p-2 gap-2  ">
                                                                            <div class="text-black text-sm cards-dm-black">WIN %</div>
                                                                            <div class="bg-[#F4F5F7] p-6 rounded-lg  font-bold cards-dm-black">{{ (isset($season->away_team->odds->win_percentage) ? $season->away_team->odds->win_percentage : "")  }}</div>
                                                                        </div>
                                                                        <div class="p-2 gap-2 w-full ">
                                                                            <div class="text-black text-sm cards-dm-black">GOALS</div>
                                                                            <div class="bg-[#F4F5F7]  p-6 rounded-lg  font-bold sg-dark-mode cards-dm-black">{{ (isset($season->away_team->odds->team_goal) ? $season->away_team->odds->team_goal : "")  }}</div>
                                                                        </div>
                                                                    </div>
                                                                </div>

                                                                <div class="flex flex-row gap-2 justify-evenly sg-dark-mode">
                                                                    <div class="flex flex-row gap-4">
                                                                        <div class="flex flex-row p-2 rounded-lg gap-2 border border-[#38b6ff] items-center">
                                                                            ...
                                                                            <div class="text-[#38b6ff] font-bold sg-dark-mode"><a href="/nhl/line-combos/{{$season->starting_goalies->home->team->slug }}">line Combinations</a></div>
                                                                    ...
                                                                    <div class="flex flex-row gap-4 w-1/3">
                                                                        <div class="flex flex-row  p-2 items-center justify-center rounded-lg gap-2 border border-[#38b6ff] w-full ">
                                                                             <div class="text-[#38b6ff] font-bold sg-dark-mode"><a href="/nhl/line-combos/{{$season->starting_goalies->away->team->slug }}">matchup</a></div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="flex flex-row gap-4">
                                                                        <div class="flex flex-row p-2 rounded-lg gap-2 border border-[#38b6ff] items-center">
                                                                            ...
                                                                            <div class="text-[#38b6ff] font-bold sg-dark-mode"><a href="/nhl/line-combos/{{$season->starting_goalies->away->team->slug }}">line Combinations</a></div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                            ...
                                            <div class="flex flex-col items-center justify-between gap-2 sm:w-2/12  w-full ">
                                                ...
                                                <div class="flex flex-row items-center justify-center gap-2 text-sm font-bold bg-white  border border-black rounded-lg w-full p-2 text-center starting-goalies-away-view-card cursor-pointer view-news starting-goalies-view-card" rel="sg-view-card-away-{{$season->starting_goalies->away->id}}"  >
                                                    <img  class="w-5 h-5"  src="{{ asset('/images/home-page/plus.png') }}"  />
                                                    <span class="text-black">
                                                        view card
                                                    </span>
