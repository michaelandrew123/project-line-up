...
<div class="w-full flex justify-center bg-slate-100">
    <div class="w-11/12 flex flex-col border-black m-4 gap-5">
        ...
        <div class="flex flex-row justify-between w-full">
            ...
            <button class="xl:text-2xl lg:text-lg font-bold bg-[#38b6ff] text-black xl:px-11 lg:px-8 py-2 rounded-md">LINE COMBOS</button>
    ...
    <div class="w-11/12 flex flex-row justify-between gap-3">
        <div class="flex flex-col  w-9/12 gap-5">
            <div class="w-full bg-[#d9d9d9] flex flex-row  items-center rounded-md">
                <img class="w-[4rem] rounded-lg justify-self-start" src="{{ asset('/images/menu-icon/mobile-_line_combo-DFS.pdf-1__2_-removebg-preview.png') }}" >
                <h1 class="text-xl font-bold text-center">Toronto Maples Leafs Team News</h1>
            </div>
            <div class="flex flex-row justify-between w-full">
