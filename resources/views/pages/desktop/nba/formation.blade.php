...
<div id="shirt-footer" class="flex flex-col gap-2 ">
    <div class="flex flex-col gap-2 mt-0 sm:mt-0 w-full" id="forwards">
        <div class=" rounded-[13px] " style=" background-color: {{  ( !empty($color1) ? $color1: '#f5f5f5')  }}">
            ...
            <h1 class="w-full py-2 text-base text-center font-medium" style=" color: {{  ( !empty($color2) ? $color2: 'black')  }}">LINEUP</h1>
        </div>
            ...
            @foreach($result->data->slots as $key=>$item)
                @if($key == 'sf')
                    <div class="flex flex-col items-center w-[30%]">
                        <div class="xl:w-[150px] lg:w-[150px] md:w-[127px]">
        ...
        <div class="hidden flex flex-row  mt-4 sm:mt-10 gap-3 justify-center">
            @foreach($result->data->slots as $key=>$item)
                @if($key == 'lw3')
                    <div class="flex flex-col items-center w-[30%]">
                        <div class="xl:w-[200px] lg:w-[200px] md:w-[150px]">
    ...
    <div class="hidden flex flex-col w-full mt-4 sm:mt-10 " id="defence">
        <div class="py-2 rounded-[13px]" style=" background-color: {{  ( !empty($color1) ? $color1: '#f5f5f5')  }}">
    ...
    <div class="hidden flex flex-col w-full mt-4 sm:mt-10" id="goalie">
    ...
    <div class="hidden flex flex-col w-full mt-4 sm:mt-10">
        <div class="py-2 rounded-lg" style=" background-color: {{  ( !empty($color1) ? $color1: '#f5f5f5')  }}">
