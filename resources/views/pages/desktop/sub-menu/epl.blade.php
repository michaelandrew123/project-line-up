<li class="nhl-linecombos_ nav-itms" >
    <a  href="/{{ request()->segment(1) }}/predicted-lineups" style="{{ (request()->segment(2) == 'predicted-lineups' ? ' color:#38b6ff;' : '') }} z-index: 1; cursor:pointer"  class="text-sm xl:text-lg lg:text-base md:text-sm font-bold text-center">
        Predicted Lineups
    </a>
</li>
<li class="">
