...
<div class="w-full flex justify-center bg-slate-100">
    ...
    <div class="flex flex-row justify-center gap-1 lg:gap-2 md:gap-1 w-full block smm-hidden">
        <div class="flex flex-col xl:w-9/12 lg:w-9/12 md:w-11/12  max-w-screen-2xl ">
            <div class="flex flex-col">
                <div class="flex flex-row w-full justify-evenly md:justify-between mb-3">
                    <div class="flex flex-col items-center gap-3 w-[32%] h-[21rem]  rounded-xl bg-white border border-black relative">                        
                        <div class="flex flex-col justify-center ml-2 xl:gap-20 lg:gap-14 md:gap-16 m-1 mt-5">
                    ...
                    <div class="flex flex-col gap-3 w-[32%] h-[21rem]  rounded-xl bg-white border border-black relative">
                        <div class="flex m-1 mt-5 ">
                            <div class="flex flex-col justify-center ml-2 xl:gap-20 lg:gap-[4.5rem] md:gap-16 ">
                                <div class="flex flex-row gap-2">
