...
<div class="flex justify-between">
                        <div class="flex flex-col md:overflow-x-auto sm:overflow-x-auto">
                ...
                <div>
                  ...
                  <div class="flex md:flex-row sm:flex-col mb-10 mt-10">
                        <div class="w-[18rem] h-80 border border-black relative  ">
                                        <div class="flex m-1 mt-5 ">
                                            <img class="w-20 h-24 " src="{{ asset('/images/Anaheim/MASON-MCTAVISH-37.png') }}">
                                            <div class="ml-2">
                  ...
                  <div class="flex md:flex-row sm:flex-col">
                        <div class="w-[18rem] h-80 border border-black relative  ">
                              ...
                              <div class="flex flex-col overflow-x-visible md:overflow-x-auto sm:overflow-y-hidden">
                                   <div class="bg-lime-400 w-36 h-full text-center"><h1>ADDS</h1>
                                   </div>
                                   <div class="bg-lime-400 w-36 h-full mb-10 mt-10 text-center"><h1>ADDS</h1>
                                   </div>
