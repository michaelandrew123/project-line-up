            ...
            <div class="nhl-pn-container-header container-header">
                ...
                <div class="nhl-pn-container-slider container-slider">
                    <div class="nhl-pn-slider-wrapper slider-wrapper">
                        <!-- Slider controls -->
                        <button type="button" id="prev-slide-tight-end"  rel="tight-end" class="hidden nhl-pn-slide-button home-pn-slide-button slide-button absolute start-0 z-30   items-center justify-center  cursor-pointer group focus:outline-none" data-carousel-prev>
                        ...
                        <div  class="nhl-pn-image-list home-pn-image-list image-list-tight-end image-list" rel="tight-end">
                            @php
                                $tight_end_count = 0;
                                $tight_end_bg_color = '';
                                $tight_end_type_icon = ''
                            @endphp
                            @foreach($tight_end as $key=>$val)
                                @php
                                    $tight_end_count++
                                @endphp
{{--                                {{ ($tight_end_count  > 6) ? 'hidden' : '' }}--}}

                                <div class="nfl-image-item home-pn-image-item image-item tight-end" >
                                        ...
                                        <div class=" card-wd bg-white rounded-[13px]">
                                            <div class="flex flex-col gap-4 items-center justify-center relative">
                                                ...
                                                @elseif($val->type->slug == 'doubtful' || $val->type->slug == 'questionable')
                                                    @php
                                                        $tight_end_bg_color = 'bg-[#FE6601]';
                                                        $tight_end_type_icon ='';
                                                    @endphp
                                                @elseif($val->type->slug == 'game-time-decision')
                                                    @php
                                                        $tight_end_bg_color = 'bg-[#000000]';
                                                        $tight_end_type_icon ='';
                                                    @endphp
                                                @else
                                                    @php
                                                        $tight_end_bg_color = 'bg-[#38B6FF]';
                                                        $tight_end_type_icon ='';
                                                    @endphp
                                                @endif

                                                <div class="flex flex-row justify-center gap-3 {{ $tight_end_bg_color }} p-2 text-white items-center w-full rounded-b-[13px]">
                                                    @if(!empty($tight_end_type_icon))
                                                        <img class="w-[15px] h-[15px]" src="{{ asset($tight_end_type_icon) }}">
                                                    @endif
                        ...
                        <button type="button" id="next-slide-tight-end"  rel="tight-end"  class="nhl-pn-slide-button slide-button absolute  end-0 z-30  items-center justify-center  cursor-pointer group focus:outline-none right-0"  data-carousel-next>
                            <span class="inline-flex items-center justify-center w-11 h-11 rounded-full bg-white/30 dark:bg-gray-800/30 group-hover:bg-white/50 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
                                <svg class="w-4 h-4 text-white dark:text-gray-800 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
