                            ...
                            @foreach($line_combinations->data as $key=>$val)
                                ...
                                <div class="nhl-lc-image-item" >
                                    ...
                                    <div class="  bg-white border rounded-[13px] border border-[#d9d9d9]">
                                        <div class="flex flex-col mx-3 my-5 gap-2 items-center justify-center">
                                            ...
                                            @if($val->type->slug == 'injury')
                                                @php
                                                    $lc_type_icon ='/images/menu-icon/white-plus.png';
                                                    $lc_bg_color = 'bg-red-500';
                                                @endphp
                                            @elseif($val->type->slug == 'morning-skate')
                                                @php
                                                    $lc_bg_color = 'bg-yellow-500';
                                                 $lc_type_icon ='';
                                                @endphp

                                            @elseif($val->type->slug == 'starting-goalie')
                                                @php
                                                    $lc_bg_color = 'bg-orange-500';
                                                    $lc_type_icon ='';
                                                @endphp
                                            @endif
                                            <div class="flex flex-row justify-center gap-3 {{ $lc_bg_color }} p-2 text-white items-center w-10/12 rounded-[13px]">
                                    ...
                                    <div class="">
                                        ...
                                        <div class="h-full sg-view-news-desc  hidden" id="sg-{{$val->id}}">
