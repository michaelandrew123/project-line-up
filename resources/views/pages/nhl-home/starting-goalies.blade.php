                                ...
                                <div class="nhl-sg-image-item image-item " >
                                    ...
                                    <div class="  bg-white border rounded-[13px] border border-[#d9d9d9]">
                                        <div class="flex flex-col mx-3 my-5 gap-2 items-center justify-center">
                                            <img class="w-44" src="{{  ( !empty($sg_val->player->images->uniform) ? $sg_val->player->images->uniform : '')     }}">

                                            @if($sg_val->type->slug == 'injury')
                                                @php
                                                    $sg_type_icon ='/images/menu-icon/white-plus.png';
                                                    $sg_bg_color = 'bg-red-500';
                                                @endphp
                                            @elseif($sg_val->type->slug == 'morning-skate')
                                                @php
                                                    $sg_bg_color = 'bg-yellow-500';
                                                 $sg_type_icon ='';
                                                @endphp

                                            @elseif($sg_val->type->slug == 'starting-goalie')
                                                @php
                                                    $sg_bg_color = 'bg-green-500';
                                                    $sg_type_icon ='';
                                                @endphp
                                            @endif
                                            <div class="flex flex-row justify-center gap-3 {{ $sg_bg_color }} p-2 text-white items-center w-10/12 rounded-[13px]">
                                                {{--<img class="w-[15px] h-[15px]" src="{{ asset('/images/menu-icon/injury icon.png') }}">--}}

                                                @if(!empty($sg_type_icon))
                                                    <img class="w-[15px] h-[15px]" src="{{ asset($sg_type_icon) }}">
                                                @endif
                                    ...
                                    <div class="">
                                        <div class="flex flex-row items-center gap-2 justify-center  p-2 rounded-[13px] border border-[#d9d9d9] bg-white cursor-pointer nhlsg-view-news " rel="modalNhlSg-{{$sg_val->id}}" >
                                        ...
                                        <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
                                            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                                                ...
                                                <div class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                                                    ...
                                                    <div class="close-modal" rel="modalNhlSg-{{$sg_val->id}}"></div>


                                                    {{--<div class="relative">--}}
                                                    {{--<div   class="close close-modal" rel="modalNhlSg-{{$sg_val->id}}" style="z-index: 1"> </div>--}}
                                                    {{--</div>--}}
                                                    ...
                                                    <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                                                        ...
                                                        <div class="flex flex-col gap-4 w-full h-full relative rounded-xl bg-white  ">
                                                            <div class="flex m-3 mt-5 gap-5">
                                                                <img class="w-[150px] h-[150px]" src="{{  ( !empty($sg_val->player->images->uniform) ? $sg_val->player->images->uniform : '')     }}">
