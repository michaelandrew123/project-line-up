    ...
    <div class="flex flex-row gap-3 w-full">
        <div class="flex flex-row justify-between items-center w-full items-center">
            <div class="flex flex-row sm:gap-4 gap-2 items-center">
                ...
                <h1 class="text-xl xl:text-lg lg:text-base md:text-sm  font-bold">NFL</h1>
            </div>
                            ...
                            @foreach($nfl_results->data as $key=>$val)
                                ...
                                <div class="nfl-image-item image-item" >
                                    ...
                                    <div class="">
                                        ...
                                        @else
                                            <div class="card-wd flex flex-row items-center gap-2 justify-center  p-2 rounded-[13px] border border-[#d9d9d9] bg-white cursor-pointer nfl-view-news view-news" rel="modalNfl-{{$val->id}}" >
                                                <img class="w-[15px] h-[15px]" src="{{ asset('/images/home-page/plus.png') }}">
                                                <h1 class="text-base ">
                                                    view news
                                                </h1>
