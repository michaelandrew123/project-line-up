...
<!-- Mobile design -->
    <div class="w-full flex justify-center hidden smm-block">
        ...
        <div id="carouselExampleCaptions2" class="relative" data-te-carousel-init data-te-carousel-slide>
            ...
            <div class="relative w-full overflow-hidden after:clear-both after:block after:content-[''] ">                 
                @php
                   $nhl_starting_goalies = 0;
                @endphp
                @foreach($goalies->data as $key=>$val)
                    @if(isset($val->metafields->goalie_status))
                        @if($val->metafields->goalie_status->name === 'Confirmed')  
                            @if($nhl_starting_goalies == 0)
                                <div
                                            ...
                                            <div class="flex mx-2 mt-5 ">
                                                ...
                                                <div class="flex flex-col ml-2 gap-3">
                                                    <div class="flex flex-row gap-2">
                                                        ...
                                                        <p class="text-md font-bold"> {{$val->metafields->goalie_status->name}}</p>
                                                    </div>
                                                    <div class="flex flex-col">
                    ...
                    <div class=" flex justify-center">                       
                        <div class="flex flex-col gap-3 w-[23rem] h-[21rem]  rounded-xl bg-white relative border border-black mx-5">
                            ...
                            <div class=" ml-1">
                                ...
                                <p class="xl:text-[11px] lg:text-[9px] md:text-[7px] font-semibold">The Pittsburgh Penguins have announce that defenseman Kris Letang will be out indefinitely after sufffering a stroke. The team said Letang is 'not experiencing any lasting effect"and will continue to undergo test over the next few day.</p>
                            </div>
                            <div class="flex flex-row items-center absolute left-3 bottom-2">
                                <img class="w-14 h-14" src="{{ asset('/images/starting-goalies/twitter-removebg-preview.png') }}">
                                <div>
