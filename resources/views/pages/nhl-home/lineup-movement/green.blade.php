            ...
            <div class="nhl-movement-container-header container-header">
                ...
                <div class="nhl-movement-container-slider container-slider">
                    <div class="nhl-movement-slider-wrapper slider-wrapper">
                        <!-- Slider controls -->
                        <button type="button" id="prev-slide" class="hidden nhl-movement-green-slide-button slide-button absolute start-0 z-30   items-center justify-center  cursor-pointer group focus:outline-none" data-carousel-prev>
                        ...
                        <div  class=" nhl-movement-image-list image-list">
                            ...
                            @foreach($team_movement->data as $key=>$val)
                                ...
                                {{ (request()->segment(1) == 'epl') ? 'epl-image-item ' : '' }} nhl-movement-image-item image-item green" >
                                    ...
                                    <div class="card-wd  bg-white rounded-[13px]">
                                        <div class="flex flex-col gap-4 items-center justify-center relative">
                                            ...
                                            <div class="flex flex-row justify-center gap-3 bg-[#111111] p-2 text-white items-center w-full rounded-b-[13px]" style="color: green !important;">
                        ...
                        <button type="button" id="next-slide" class="hidden nhl-movement-green-slide-button slide-button absolute  end-0 z-30  items-center justify-center  cursor-pointer group focus:outline-none right-0"  data-carousel-next>
                            <span class="inline-flex items-center justify-center w-11 h-11 rounded-full bg-white/30 dark:bg-gray-800/30 group-hover:bg-white/50 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
                                <svg class="w-4 h-4 text-white dark:text-gray-800 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
