...
<div class="w-full flex justify-center block smm-hidden">
    <div class="xl:w-11/12 lg:w-11/12 md:w-full flex flex-col border-black m-4 gap-5">
        <div class="flex flex-row justify-between items-ce flex justify-centernter">
        ...
        <div class="flex flex-row justify-between w-full gap-3">
            ...
            <button class="flex xl:text-2xl lg:text-lg font-bold bg-[#ebece9] text-black xl:px-9 px-6  py-2 rounded-md"hidden>PROPS & ODDS
                <img class="w-7" src="{{ asset('/images/menu-icon/lock (1).png') }}" alt="">
            </button>
        </div>
            <div class="relative">
   ...
   <div id="drf-shp" class="hidden w-full flex flex-col items-center block smm-hidden">
        <div class="w-11/12 md:w-full flex flex-col items-center gap-6 ">
            <div class="bg-slate-300 h-[2px] w-11/12"></div>
                ...
                <div class="flex flex-row justify-between w-11/12 gap-3.5">
                    <div class="flex flex-row items-end gap-2 w-8/12 ">
                        <div class="w-11/12 flex flex-col items-center">
                            <p class="w-[10rem] text-center text-sm bg-slate-300 p-0.5 border rounded-lg font-bold">ALEXANDER KERFOOT</p>
                        ...
                        <div class="hidden w-[50%] h-[95%] bg-slate-300 flex flex-col justify-between border rounded-lg drftking">
                            <div class="flex flex-col gap-3 mt-1.5">
                                <h3 class="text-2xl font-semibold text-center">Proj.</h3>
                                <h1 class="text-5xl font-extrabold text-center">12.3</h1>
                            </div>
                        ...
                        <div class="flex flex-col gap-3 mt-1.5">
                                <h3 class="text-2xl font-semibold text-center">Proj.</h3>
                                <h1 class="text-5xl font-extrabold text-center">5.3</h1>
                            </div>
                        ...
                        <div class="flex flex-col gap-3 mt-1.5">
                                <h3 class="text-2xl font-semibold text-center">SHOTS</h3>
                                <h1 class="text-5xl font-extrabold text-center">2.5</h1>
                            </div>
                            <div class="bg-[#ffa100] flex justify-center w-full py-3 border rounded-lg">
                            <h3 class="text-xl font-semibold text-center">CHART</h3>
                            <img class="w-7" src="{{ asset('/images/menu-icon/lock (1).png') }}" alt="">
                            </div>
                        </div>
                        ...
                        <div class="w-[50%]  h-[95%]  bg-slate-300 flex flex-col justify-between border rounded-lg hidden stats">
                            <div class="flex flex-col gap-5  items-center mt-1.5 text-sm font-semibold">
                                <p>Start per Game</p>
                                <ul class="">
                                    <li style="word-spacing: 10px;" class="text-sm ">Goals .45</li>
                                    <li style="word-spacing: 10px;" class="text-sm ">Assist   .35</li>
                                    <li style="word-spacing: 10px;" class="text-sm ">Points   .80</li>
                                    <li style="word-spacing: 10px;" class="text-sm ">Shots   2.76</li>
                                    <li style="word-spacing: 10px;" class="text-sm ">Blocks   1.2</li>
                                    <li style="word-spacing: 10px;" class="text-sm ">TOI    16:53</li>
                                    <li style="word-spacing: 10px;" class="text-sm ">PP TQI    2.12</li>
                                </ul>
                            </div>
                            <div class="bg-[#ffa100] w-full py-3 border rounded-lg">
                                <h3 class="text-xl font-semibold text-center">Last 5</h3>
                                <img class="w-7" src="{{ asset('/images/menu-icon/.png') }}" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="flex flex-row items-end w-8/12 gap-2 ">
                        <div class="w-11/12 flex flex-col items-center">
                            <p class="w-[10rem] text-center text-sm bg-slate-300 p-0.5 border rounded-lg font-bold">AUSTON MATTHEWS</p>
                            <img src="{{ asset('/images/menu-icon/Copy_of_jersey.png') }}" class=" px-3" alt="">
                        </div>               
                        <div class="hidden w-[50%] h-[95%] bg-slate-300 flex flex-col justify-between border rounded-lg drftking">
                            <div class="flex flex-col gap-3 mt-1.5">
                ...
                <div class="flex flex-row justify-between w-11/12 gap-3.5">
                    ...
                    <div class="flex flex-row items-end w-8/12 gap-2 ">
                        ...
                        <div class="w-[50%]  h-[95%]  bg-slate-300 flex flex-col justify-between border rounded-lg hidden stats">
                        <div class="flex flex-col gap-5 items-center gap1.5 text-sm font-semibold">
                                <p>Start per Game</p>
                                <ul class="">
                                    <li style="word-spacing: 10px;" class="text-sm ">Goals .45</li>
                                    <li style="word-spacing: 10px;" class="text-sm ">Assist   .35</li>
            ...
            <div class="w-10/12 flex flex-row justify-between my-10">
                <div class="flex flex-col items-center gap-8 w-9/12  md:w-full">
                    ...
                    <div class="flex flex-row justify-between w-11/12 gap-3.5">
                        <div class="flex flex-row items-end w-8/12 gap-2 ">
                            ...
                            <div class="w-[50%] h-[9 5%] bg-slate-300 flex flex-col justify-between border rounded-lg hidden stats">
                            <div class="flex flex-col gap-5  items-center mt-1.5 text-sm font-semibold">
                                <p>Start per Game</p>
                                <ul class="">
                                    <li style="word-spacing: 10px;" class="text-sm ">Goals .45</li>
                ...
                <img class="xl:w-[20rem] w-[10rem]  h-3/5 lg:h-2/5 md:h-2/5" src="{{ asset('/images/menu-icon/adds1.png') }}">
            </div>
                ...
                <div class="flex flex-col w-11/12 gap-5">                    
                    ...
                    <div class="flex flex-row justify-between w-[61%] gap-3.5 ">
                    <div class="flex flex-row items-end w-10/12 gap-2 ">
                        <div class="w-10/12 flex flex-col items-center">
                            <p class="w-[10rem] text-center text-sm bg-slate-300 p-0.5 border rounded-lg font-bold">AUSTON MATTHEWS</p>
                            <img src="{{ asset('/images/menu-icon/Copy_of_jersey.png') }}" class=" px-3" alt="">
                        </div>               
                        <div class="w-[46%] h-[95%] bg-slate-300 flex flex-col justify-between border rounded-lg hidden drftking">
                            <div class="flex flex-col gap-3 mt-1.5">
                                <h3 class="text-2xl font-semibold text-center">Proj.</h3>
                                <h1 class="text-5xl font-extrabold text-center">12.3</h1>
                            </div>
                        ...
                        <div class="w-[46%] h-[95%] bg-slate-300 flex flex-col justify-between border rounded-lg hidden fduel">
                        <div class="flex flex-col gap-3 mt-1.5">
                                <h3 class="text-2xl font-semibold text-center">Proj.</h3>
                                <h1 class="text-5xl font-extrabold text-center">12.3</h1>
                            </div>
                        ...
                        <div class="w-[46%] h-[95%] bg-slate-300 flex flex-col justify-between border rounded-lg hidden props">
                        <div class="flex flex-col gap-3 mt-1.5">
                                <h3 class="text-2xl font-semibold text-center">SHOTS</h3>
                                <h1 class="text-5xl font-extrabold text-center">2.5</h1>
                            </div>
                        ...
                        <div class="w-[46%] h-[95%] bg-slate-300 flex flex-col justify-between border rounded-lg hidden shop">
                        <div class="flex flex-col gap-3 mt-1.5">
                                <img src="" alt="">
                            </div>
                            <div class="bg-[#ffa100]  w-full py-3 border rounded-lg">
        ...
        <div class="w-[95%] mx-5">   
            ...
            <div class="mx-3">             
                ...
                <div class="flex flex-row items-center w-full justify-evenly mt-3 z-10" id="sub-hed">
                    ...
                    <button class="w-full bg-slate-100 mx-1 py-4 font-semibold rounded-sm fnl">FANDUEL</button>
                    <button class="w-full bg-slate-100 mx-1 py-4 font-semibold rounded-sm sts">STATS</button>
                    <button class="w-full bg-slate-100 text-lg py-4 font-semibold rounded-md prp">PROPS</button>
                    <button class="w-full bg-slate-100 text-lg py-4 font-semibold rounded-md flex justify-center items-center shp">SHOP
                        <img class="w-7" src="{{ asset('/images/menu-icon/shopping-bag.png') }}" alt="">
                    </button>
                </div>
                <div id="shirt-footer"  class="flex flex-col gap-2 shirt-players">
                    <div class="flex flex-col gap-2 w-full">
                        <h1 class="text-center font-extrabold text-md mt-1 mb-6">FORWARDS</h1>
                        <div class="flex flex-row justify-between">
                            <div class="flex flex-row items-center  rounded-md gap-2 sm:w-full smm-w-[10rem]  border border-black">
                                <div class="w-32 ">
                                    <p class="text-center text-[10px] bg-slate-300 p-0.5 border rounded-lg font-bold">ALEXANDER KERFOOT</p>
                                    <img src="{{ asset('/images/menu-icon/Copy_of_jersey.png') }}" class="mb-2.5 " alt="">
                                </div>
                                 <div class="w-20 h-36 border border-black">
                                          
                                 </div>
                            </div>
                            <div class="flex flex-row items-center  rounded-md gap-2 sm:w-full smm-w-">
                                <div class="w-32">
                                    <p class="text-center text-[10px] bg-slate-300 p-0.5 border rounded-lg font-bold">AUSTON MATTHEWS</p>
                                    <img src="{{ asset('/images/menu-icon/Copy_of_jersey.png') }}" class="mb-2.5 " alt="">
                                </div>
                                <div class="w-20 h-36 border border-black">
                            ...
                            <div class="flex flex-row items-center  rounded-md gap-2 w-full">
                                <div class="w-32">
                                    <p class="text-center text-[10px] bg-slate-300 p-0.5 border rounded-lg font-bold">MITCH MARNER</p>
                                    <img src="{{ asset('/images/menu-icon/Copy_of_jersey.png') }}" class="mb-2.5 " alt="">
                                </div>
                                <div class="w-20 h-36 border border-black">
