                ...
                @foreach($result as $val)
                    ...
                    <!-- Your existing code -->
                        ...
                        <div class="flex flex-col items-center w-[30%] sm:gap-2 gap-0 ">
                            <div class="">
                                <div class="relative sm:h-auto h-24 sm:w-28 w-20 xl:w-32">
                ...
                @if(is_object($val) && isset($val->slots->{'starter-3'}))
                    <!-- Your existing code -->
                        ...
                        <div class="flex flex-col items-center w-[30%] sm:gap-2 gap-0 ">
                            <div class="">
                                <div class="relative sm:h-auto h-24 sm:w-28 w-20 xl:w-32">
                                    <img class="nhl-images" src="{{ $val->slots->{'starter-3'}->images->uniform }}" sizes=" (max-width: 768px) 30vw, (max-width: 1200p) 10vw, 50vw" alt="">
                                </div>
                            </div>
                            <div class="sm:hidden block">
                    ...
                    <!-- Your existing code -->
                        ...
                        <div class="flex flex-col items-center w-[30%] sm:gap-2 gap-0 ">
                            <div class="">
                                <div class="relative sm:h-auto h-24 sm:w-28 w-20 xl:w-32">
                                    <img class="nhl-images" src="{{ $val->slots->{'starter-4'}->images->uniform }}" sizes=" (max-width: 768px) 30vw, (max-width: 1200p) 10vw, 50vw" alt="">
                                </div>
                            </div>
                            <div class="sm:hidden block">
                    ...
                    <!-- Your existing code -->
                        ...
                        <div class="flex flex-col items-center w-[30%] sm:gap-2 gap-0 ">
                            <div class="">
                                <div class="relative sm:h-auto h-24 sm:w-28 w-20 xl:w-32">
                                    <img class="nhl-images" src="{{ $val->slots->{'starter-5'}->images->uniform }}" sizes=" (max-width: 768px) 30vw, (max-width: 1200p) 10vw, 50vw" alt="">
                                </div>
                            </div>
                            <div class="sm:hidden block">
                    ...
                    <!-- Your existing code -->
                        ...
                        <div class="flex flex-col items-center w-[30%] sm:gap-2 gap-0 ">
                            <div class="">
                                <div class="relative sm:h-auto h-24 sm:w-28 w-20 xl:w-32">
                                    <img class="nhl-images" src="{{ $val->slots->{'starter-6'}->images->uniform }}" sizes=" (max-width: 768px) 30vw, (max-width: 1200p) 10vw, 50vw" alt="">
                                </div>
                            </div>
                            <div class="sm:hidden block">
                    ...
                    <!-- Your existing code -->
                        ...
                        <div class="flex flex-col items-center w-[30%] sm:gap-2 gap-0 ">
                            <div class="">
                                <div class="relative sm:h-auto h-24 sm:w-28 w-20 xl:w-32">
                                    <img class="nhl-images" src="{{ $val->slots->{'starter-7'}->images->uniform }}" sizes=" (max-width: 768px) 30vw, (max-width: 1200p) 10vw, 50vw" alt="">
                                </div>
                            </div>
                            <div class="sm:hidden block">
