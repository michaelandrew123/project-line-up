    ...
    <div class="xl:w-11/12 lg:w-full md:w-full flex flex-col items-center justify-between gap-1 max-w-screen-2xl ">
        ...
        <div class="w-full flex flex-col items-center hidden">
            ...
            <div class="relative w-full">
                ...
                <input type="text" class="w-full  text-center text-xl text-[#4d4d4d] rounded h-14" type="text" placeholder="Search Projected Lineups" style="border: 2px solid #38B6FF">
