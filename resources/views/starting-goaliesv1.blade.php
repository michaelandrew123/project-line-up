...
<div class="">
            <div class="flex justify-center mb-3 ">
                <div class="bg-sky-500/100 w-[49rem] h-24 p-2 flex ">
                    <h1 class="text-white text-3xl font-bold">NASHILLE <br> PREDATOR </h1>
                    <h1 class="text-white text-3xl font-bold ml-60">CAROLINA <br>HURRICANES</h1>
                    <p class="text-white text-md font-bold ml-20">FEB 18TH, 2022 7:00PM EST</p>
                </div>
            </div>
      <div class="flex justify-center">
            <div class="w-96 h-5/6 border border-black relative mr-4">
                    <div class="flex m-3 mt-5 ">
                        ...
                        <div class="ml-2">
                            ...
                            <h1 class="text-2xl font-extrabold">JUUSE SAROS</h1>
                    ...
                    <div class="m-3 mb-5 pb-5">
                        <p class="text-[16px] font-bold mb-5">Saros was the first gaolie off the ice <br> at morning skate</p>
            ...
            <div class="w-96 h-5/6 border border-black relative">
                    <div class="flex m-3 mt-5 ">
                        <img class="w-24 h-32 " src="{{ asset('/images/Anaheim/MASON-MCTAVISH-37.png') }}">
                        <div class="ml-2">
                            ...
                            <h1 class="text-2xl font-extrabold">PREDRIK ANDERSON</h1>
                            <p class="text-[14px] font-extrabold">Toronto Maple Leafs</p>
                            <div class="flex mt-4">
                                <img class="w-6 h-5" src="{{ asset('/images/starting-goalies/pinpng.png') }}">
                                <p class="text-[14px] font-bold ml-1">$8,700</p>
                    ...
                    <div class="m-3 mb-5 pb-5">
                        <p class="text-[16px] font-bold mb-5">Anderson was the first gaolie off the ice <br>at morning skate</p>
