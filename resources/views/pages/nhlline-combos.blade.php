...
<div class="w-full flex flex-col items-center ">
    ...
    <div class="flex flex-row items-center w-11/12 justify-evenly mt-3 gap-2.5 text-slate-500" id="sub-hed">
    ...
    <!-- End of Line-ups -->
   <div id="drf-shp" class="hidden w-full flex flex-col items-center">
        <div class="w-11/12 flex flex-col items-center gap-6 block smm-hidden">
                ...
                <div class="flex flex-row justify-between w-11/12 gap-3.5">
                    <div class="flex flex-row items-end gap-2 w-8/12 ">
                        ...
                        <div class="w-[50%] h-[95%] bg-slate-300 flex flex-col justify-between border rounded-lg hidden stats">
                            <div class="flex flex-col items-center gap-3 mt-1.5 text-sm font-semibold">
                                <p>Start per Game</p>
                                <ul class="">
                                    <li style="word-spacing: 10px;">Goals .45</li>
                                    <li style="word-spacing: 10px;">Assist   .35</li>
                                    <li style="word-spacing: 10px;">Points   .80</li>
                                    <li style="word-spacing: 10px;">Shots   2.76</li>
                                    <li style="word-spacing: 10px;">Blocks   1.2</li>
                                    <li style="word-spacing: 10px;">TOI    16:53</li>
                                    <li style="word-spacing: 10px;">PP TQI    2.12</li>
                                </ul>
                            </div>
                            <div class="bg-[#ffa100] w-full py-3 border rounded-lg">
            ...
            <div class="w-10/12 flex flex-row justify-between my-10">
                <div class="flex flex-col items-center gap-8 w-9/12  ">
                    <div class="bg-slate-300 h-[2px] w-11/12"></div>
                ...
                <img class="w-[20rem] h-3/5 " src="{{ asset('/images/menu-icon/adds1.png') }}">
            </div>
